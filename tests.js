...
// On importe les fonctions exportées depuis script.js
// Note : les fonctions qui dépendent du DOM (generatePassword, etc.) ne sont pas testées ici
